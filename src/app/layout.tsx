...
export const metadata: Metadata = {
  ...
  description:
    "Professional designer and illustrator based in Istanbul. Specializing in illustration, UI/UX design, and animation. View my creative portfolio and contact me for collaborations.",
  keywords:
    "Anıl Emmiler, designer, illustrator, Istanbul, UI/UX design, illustration, animation, graphic design, portfolio, Turkey",
  ...
  openGraph: {
    ...
    description:
      "Professional designer and illustrator based in Istanbul. Specializing in illustration, UI/UX design, and animation.",
